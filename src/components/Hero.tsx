  ...
  return (
    ...
    >
      ...
      <AnimatedSection delay={0.8}>
        ...
        >
          LaserFlow is the AI infrastructure layer that eliminates lead leakage, automates
          patient communication, and fills treatment chairs — without adding a single staff member.
        </p>
      </AnimatedSection>
    </section>
  )
